...
export const eventsData: EventData[] = [
  ...
  },
  {
    id: "sep1",
    emoji: "🎂",
    title: "День Рождения Набережной",
    subtitle: "1 Сентября 2026",
    date: "1 сентября 2026",
    time: "Начало в 18:30",
    location: "Кремлевская набережная, 1",
    description:
      "Главный праздник года! Мы отмечаем день рождения Кремлёвской набережной с роскошной программой: живые выступления, фейерверк, угощения и интерактивные зоны для всей семьи.",
    highlights: [
